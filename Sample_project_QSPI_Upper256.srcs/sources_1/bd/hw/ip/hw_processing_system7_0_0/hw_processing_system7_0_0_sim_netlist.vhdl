...
--               d:/All/Software/ZZ-Hardware_Old/Sample_Code_Alghasi/Sample_project_QSPI_Upper256/Sample_project_QSPI_Upper256.srcs/sources_1/bd/hw/ip/hw_processing_system7_0_0/hw_processing_system7_0_0_sim_netlist.vhdl
...
entity hw_processing_system7_0_0_processing_system7_v5_5_processing_system7 is
  ...
  attribute C_USE_M_AXI_GP0 of hw_processing_system7_0_0_processing_system7_v5_5_processing_system7 : entity is 0;
...
entity hw_processing_system7_0_0 is
  ...
  attribute X_CORE_INFO of hw_processing_system7_0_0 : entity is "processing_system7_v5_5_processing_system7,Vivado 2019.1";
...
architecture STRUCTURE of hw_processing_system7_0_0 is
  ...
  attribute POWER : string;
  attribute POWER of inst : label is "<PROCESSOR name={system} numA9Cores={2} clockFreq={766.666687} load={0.5} /><MEMORY name={code} memType={DDR3} dataWidth={32} clockFreq={533.333333} readRate={0.5} writeRate={0.5} /><IO interface={GPIO_Bank_1} ioStandard={LVCMOS18} bidis={0} ioBank={Vcco_p1} clockFreq={1} usageRate={0.5} /><IO interface={GPIO_Bank_0} ioStandard={LVCMOS33} bidis={1} ioBank={Vcco_p0} clockFreq={1} usageRate={0.5} /><IO interface={Timer} ioStandard={} bidis={0} ioBank={} clockFreq={127.777786} usageRate={0.5} /><IO interface={CAN} ioStandard={LVCMOS33} bidis={2} ioBank={Vcco_p0} clockFreq={100.000000} usageRate={0.5} /><IO interface={I2C} ioStandard={LVCMOS18} bidis={3} ioBank={Vcco_p1} clockFreq={127.777779} usageRate={0.5} /><IO interface={UART} ioStandard={LVCMOS18} bidis={2} ioBank={Vcco_p1} clockFreq={100.000000} usageRate={0.5} /><IO interface={SD} ioStandard={LVCMOS33} bidis={6} ioBank={Vcco_p0} clockFreq={50.000000} usageRate={0.5} /><IO interface={SD} ioStandard={LVCMOS18} bidis={8} ioBank={Vcco_p1} clockFreq={50.000000} usageRate={0.5} /><IO interface={USB} ioStandard={LVCMOS18} bidis={12} ioBank={Vcco_p1} clockFreq={60} usageRate={0.5} /><IO interface={GigE} ioStandard={LVCMOS18} bidis={14} ioBank={Vcco_p1} clockFreq={125.000000} usageRate={0.5} /><IO interface={QSPI} ioStandard={LVCMOS33} bidis={6} ioBank={Vcco_p0} clockFreq={200.000000} usageRate={0.5} /><PLL domain={Processor} vco={1533.333} /><PLL domain={Memory} vco={1066.667} /><PLL domain={IO} vco={1000.000} />/>";
  attribute USE_TRACE_DATA_EDGE_DETECTOR : integer;
  ...
  attribute X_INTERFACE_PARAMETER of FCLK_CLK0 : signal is "XIL_INTERFACENAME FCLK_CLK0, FREQ_HZ 100000000, PHASE 0.000, CLK_DOMAIN hw_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
